...
Every line in ${promptName} is separated by pipe |. Don't translate multiple ${promptName} lines together. Each pipe-separated line becomes exactly one array entry.
